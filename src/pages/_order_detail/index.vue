  ...
  <div class="index">
    <div class="box">
      <view class="table">
        ...
        <view class="tr">
            <view class="td item1">邮政编码</view>
            <view class="td item2">{{ orderDetail.postalCode }}</view>
          </view>
          <view class="tr bg-g">
            <view class="td item1">联系方式</view>
            <view class="td item2">{{ orderDetail.telNumber }}</view>
          </view>
          <view class="tr">
...
export default {
  ...
  methods: {
    ...
    async editDescription () {
      ...
      const { data } = await this.$fly.post('/order/editDes', {
        description,
    ...
    async editAddress () {
      ...
      const { data } = await this.$fly.post('/order/editAddress', {
        order_id: orderID,
        address
      })
      if (data.meta.status !== 200) {
