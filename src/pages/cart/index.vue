  ...
  <div class="indexContainer">
    ...
    <div class="index_top">
      ...
      <div class="content" v-show="address.userName">
        ...
        <div class="item_list">
          ...
          <span class="item2">{{address.provinceName+address.cityName+address.countyName+address.detailInfo}}</span>
        </div>
         <div class="item_list">
    ...
    <div class="cart_content">
      ...
      <div class="item_content">
            <div class="item" v-for="(item,index) in cart" :key="index" @longpress="deleteGoods(index)">
            ...
            <checkbox-group>
                <checkbox :checked="item.isChecked" @click="changeChecked(index)"></checkbox>
            </checkbox-group>           
        </a> 
            </div>
