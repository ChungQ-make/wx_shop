...
<view>
    ...
    <view class="detail_swiper">
        <swiper autoplay="true" circular="true" indicator-dots="true">
            <swiper-item v-for="(item,index) in goodsDetail.goods_imgUrl" :key="index" @click="handlePrevwImage">
    ...
    <view class="goods_name_row">
        ...
        <view class="goods_collect" @click="handleCollect">
            <text :class="isCollect?'iconfont icon-shoucang':'iconfont icon-shoucang1'"></text>
...
export default {
  ...
  methods: {
    ...
    async getGoodsDetail () {
      ...
      const {data} = await this.$fly.get('/goods/detail', {goods_id: goodsID})
      this.goodsDetail = data.data
      this.goodsDetail.created_time = this.$moment(this.goodsDetail.created_time).format('YYYY-MM-DD HH:mm')
      this.goodsDetail.goods_imgUrl.push('http://localhost:5000/upload/img/catitems/goods_categories.png')
